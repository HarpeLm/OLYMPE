...
SYSTEM_PROMPT = (
    ...
    "RECHERCHE WEB : si la question porte sur des faits récents "
    "(actualités, résultats sportifs, événements, prix, nominations), "
    "appelle TOUJOURS l'outil web_search avant de répondre. "
    "Ne réponds jamais à une question factuelle récente de mémoire. "
